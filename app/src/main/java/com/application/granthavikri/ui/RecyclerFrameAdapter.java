...
public class RecyclerFrameAdapter extends RecyclerView.Adapter<RecyclerFrameAdapter.ViewHolder> {
    ...
    RecyclerFrameAdapter(Context context, List<FrameModel> frameModelList, Utility.OnItemClickListener listener){
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        FrameModel data = frameModelList.get(position);

        holder.type_view.setText("Frame");
    ...
    public void setData(List<FrameModel> frameModelList){
        this.frameModelList = frameModelList;
